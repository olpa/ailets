...
def prompt_to_md(env: Environment) -> str:
    """Create a chain of nodes that process a prompt into markdown."""
    # Define the initial prompt
    initial_prompt = "Hello, how can I help you?"  # You might want to make this configurable
    
    # Define nodes and their dependencies
    env.add_node("initial_prompt", lambda: initial_prompt)  # Add source node
