...
extern "C" {
    pub fn get_errno() -> isize;

    pub fn open_read(name_ptr: *const c_char) -> isize;
    pub fn open_write(name_ptr: *const c_char) -> isize;
    pub fn aread(fd: isize, buffer_ptr: *mut u8, count: c_uint) -> isize;
    pub fn awrite(fd: isize, buffer_ptr: *const u8, count: c_uint) -> isize;
    pub fn aclose(fd: isize) -> isize;
    ...
    pub fn dag_value_node(value_ptr: *const u8, explain_ptr: *const c_char) -> isize;
    ...
    pub fn dag_alias(alias_ptr: *const c_char, node_handle: isize) -> isize;

    /// `dag_detach_from_alias` parameters:
    /// - `alias_ptr`: pointer to the C-string alias
    ///
    /// return: 0 if success, -1 if error
    pub fn dag_detach_from_alias(alias_ptr: *const c_char) -> isize;
    ...
    pub fn dag_instantiate_with_deps(workflow: *const c_char, deps: *const c_char) -> isize;
    ...
    pub fn open_write_pipe(explain_ptr: *const c_char) -> isize;
