...
def fill_wasm_import_object(
    ...
    async def n_of_slots(name_ptr: int) -> int:
        name = buf_to_str.get_string(name_ptr)
        return runtime.n_of_slots(name)
    ...
    def sync_n_of_slots(name_ptr: int) -> int:
        return asyncio.run(n_of_slots(name_ptr))
    ...
    import_object.register(
        "",
        {
            "n_of_streams": wasmer.Function(store, sync_n_of_slots),
